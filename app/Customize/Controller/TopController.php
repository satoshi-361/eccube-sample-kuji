...
class TopController extends AbstractController
{
	...
	public function __construct(){
		...
		$this->redirect_uri = 'https://'.$_SERVER['SERVER_NAME'].'/sample_eccube_kuji_1/';// リダイレクトURI
    ...
    public function index(Request $request)
    {
		...
		$lastProductId= $this->getDoctrine()->getRepository(Product::class)->findBy(array(),array('id'=>'DESC'),1,0)[0]->getId();
		$res = array();
